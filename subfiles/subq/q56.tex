...
\begin{document}
\problem{56: What is the requested URL in the frame No. 101 ?What HTTP field contains the username and password information? What are the submitted values for the username and the password?}
\begin{wts}
