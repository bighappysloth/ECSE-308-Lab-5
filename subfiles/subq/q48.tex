...
\begin{document}
\problem{48: What is the application of etag in conditional HTTP request? Which line in the second response contains the etag value of the first response?}
\begin{wts}
